...
$(LIBC): $(BUILD)/atomic.o $(BUILD)/condition.o $(BUILD)/thread_runtime.o $(BUILD)/thread.o $(BUILD)/thread_entry.o
...
$(BUILD)/condition.o: src/thread/condition.c include/threads.h include/errno.h include/mini/syscall.h | $(BUILD)
...
$(BUILD)/condition_probe.o: tests/condition_probe.c include/threads.h include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD)/condition_test_impl.o: src/thread/condition.c include/threads.h include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) $(CONDITION_RENAMES) -c $< -o $@

$(BUILD)/condition_test.o: tests/condition_test.c include/threads.h include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(HOST_CFLAGS) -c $< -o $@

$(BUILD)/condition_test: $(BUILD)/condition_test.o $(BUILD)/condition_test_impl.o $(BUILD)/errno.o
	$(CC) $(HOST_LDFLAGS) -o $@ $^
