...
all: $(BUILD)/thread_probe $(BUILD)/thread_exit_group_probe $(BUILD)/condition_probe $(BUILD)/mutex_probe $(BUILD)/once_tss_probe $(BUILD)/tls_probe $(BUILD)/condition_test $(BUILD)/mutex_test $(BUILD)/once_tss_test
...
$(BUILD)/thread_runtime.o: src/thread/runtime.c src/internal/thread_runtime.h include/threads.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
thread_test_run: $(BUILD)/thread_probe $(BUILD)/thread_exit_group_probe $(BUILD)/condition_probe $(BUILD)/mutex_probe $(BUILD)/once_tss_probe $(BUILD)/tls_probe $(BUILD)/condition_test $(BUILD)/mutex_test $(BUILD)/once_tss_test
	...
	@test "$$($(BUILD)/tls_probe)" = "native-tls-ok"
