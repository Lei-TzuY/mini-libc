...
TIME_RENAMES := -Dmini_sys_clock_gettime=mini_test_clock_gettime
...
HOST_TESTS := $(BUILD)/memory_differential $(BUILD)/string_differential \
              ...
              $(BUILD)/stdio_block_test $(BUILD)/stdio_scan_test $(BUILD)/time_test
...
$(BUILD)/posix_fd.o: src/unistd/fd.c include/unistd.h include/fcntl.h \
                     include/sys/types.h include/stdarg.h include/stddef.h \
                     include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD)/descriptor_control.o: src/unistd/control.c include/unistd.h \
...
$(BUILD)/tty.o: src/unistd/tty.c include/unistd.h include/termios.h \
...
$(BUILD)/resource.o: src/process/resource.c include/sys/resource.h \
                    include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD)/credential.o: src/process/credential.c include/unistd.h \
...
$(BUILD)/dirent.o: src/dirent/dirent.c include/dirent.h include/sys/types.h \
                   include/errno.h include/fcntl.h include/mini/syscall.h \
                   include/stddef.h include/stdlib.h include/unistd.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD)/time.o: src/time/time.c include/time.h include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD)/posix_fd_probe.o: tests/posix_fd_probe.c include/unistd.h include/fcntl.h \
                           include/sys/types.h include/errno.h include/stdio.h \
                           include/string.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD)/descriptor_control_probe.o: tests/descriptor_control_probe.c \
                                    include/unistd.h include/fcntl.h \
                                    include/errno.h include/string.h \
                                    include/sys/stat.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD)/cwd_state_probe.o: tests/cwd_state_probe.c include/unistd.h \
...
$(BUILD)/process_orchestration_probe.o: tests/process_orchestration_probe.c \
                                     include/unistd.h include/fcntl.h include/poll.h \
                                     include/sys/wait.h include/errno.h include/stdlib.h \
                                     include/string.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD)/resource_limit_probe.o: tests/resource_limit_probe.c include/sys/resource.h \
                               include/sys/stat.h include/sys/wait.h include/unistd.h \
                               include/fcntl.h include/signal.h include/stdlib.h \
                               include/string.h include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD)/credential_child_probe.o: tests/credential_child_probe.c include/unistd.h \
                                    include/fcntl.h include/sys/stat.h \
                                    include/sys/types.h include/errno.h \
                                    include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD)/credential_policy_probe.o: tests/credential_policy_probe.c include/unistd.h \
...
$(BUILD)/termios_canonical_probe.o: tests/termios_canonical_probe.c \
                                    include/unistd.h include/fcntl.h include/poll.h \
...
$(BUILD)/dirent_probe.o: tests/dirent_probe.c include/dirent.h include/errno.h \
                         include/fcntl.h include/mini/syscall.h include/stddef.h \
                         include/string.h include/sys/stat.h include/unistd.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD)/time_probe.o: tests/time_probe.c include/mini/syscall.h include/time.h include/errno.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD)/time_test_impl.o: src/time/time.c include/time.h include/errno.h include/mini/syscall.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(CFLAGS) $(TIME_RENAMES) -c $< -o $@
...
$(BUILD)/time_test.o: tests/time_test.c include/time.h include/errno.h | $(BUILD)
	$(CC) $(CPPFLAGS) $(HOST_CFLAGS) -c $< -o $@
...
$(BUILD)/posix_fd_probe: $(BUILD)/posix_fd_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/posix_fd_probe.o $(CRT0) $(LIBC)

$(BUILD)/descriptor_control_probe: $(BUILD)/descriptor_control_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/descriptor_control_probe.o $(CRT0) $(LIBC)

$(BUILD)/cwd_state_probe: $(BUILD)/cwd_state_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/cwd_state_probe.o $(CRT0) $(LIBC)
...
$(BUILD)/resource_limit_probe: $(BUILD)/resource_limit_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/resource_limit_probe.o $(CRT0) $(LIBC)

$(BUILD)/credential_child_probe: $(BUILD)/credential_child_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/credential_child_probe.o $(CRT0) $(LIBC)
...
$(BUILD)/dirent_probe: $(BUILD)/dirent_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/dirent_probe.o $(CRT0) $(LIBC)
...
$(BUILD)/time_probe: $(BUILD)/time_probe.o $(CRT0) $(LIBC)
	$(LD) -static -e _start --build-id=none -o $@ $(BUILD)/time_probe.o $(CRT0) $(LIBC)
...
$(BUILD)/time_test: $(BUILD)/time_test.o $(BUILD)/time_test_impl.o $(BUILD)/errno.o
	$(CC) $(HOST_LDFLAGS) -o $@ $^
